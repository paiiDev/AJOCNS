...
BEGIN
    ...
    (
        ...
        CONSTRAINT UQ_JobApplications_JobPost_Student UNIQUE (JobPostId, StudentId),
        ...
        CONSTRAINT FK_JobApplications_Users
            FOREIGN KEY (StudentId) REFERENCES dbo.Users(User_ID)
    );
END;
GO
...
GO
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'IX_JobApplications_StudentId')
    CREATE INDEX IX_JobApplications_StudentId ON dbo.JobApplications(StudentId);
GO
